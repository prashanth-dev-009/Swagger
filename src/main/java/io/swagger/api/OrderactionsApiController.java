...
@RestController
public class OrderactionsApiController implements OrderactionsApi {

    private static final Logger log = LoggerFactory.getLogger(OrderactionsApiController.class);
    ...
    public OrderactionsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
